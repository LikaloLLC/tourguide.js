(function (global, factory) {
  ...
  function assert(condition, message) {
    if (!Boolean(condition)) throw "TourguideJS: ".concat(message);
    return true;
  }
  ...
  function getStyle(element, css3Prop) {
    var originalEl = u$2(element).first();
    try {
  ...
  function setStyle(element, styleObj) {
    ...
    Object.assign(u$2(element).first().style, style);
    return element;
  }
  ...
  var positionfixed = function positionfixed(options) {
    return {
      name: "positionInView",
      options: options,
  ...
  var Utils = /*#__PURE__*/Object.freeze({
    ...
    getStyle: getStyle,
    setStyle: setStyle,
    colorObjToStyleVarString: colorObjToStyleVarString,
    getMaxZIndex: getMaxZIndex,
    getScrollCoordinates: getScrollCoordinates,
    setElementScroll: setElementScroll,
    ...
    _createClass(PopoverStep, [{
      ...
      get: function get() {
        if (!this.$container) {
          ...
          if (this.data.width) this.context.helpers.setStyle(tooltip, {
            width: this.data.width + "px",
            maxWidth: this.data.width + "px"
          });
          if (this.data.height) this.context.helpers.setStyle(tooltip, {
      ...
      value: function _validate(data) {
        this.context.helpers.assert(data.hasOwnProperty("title"), "missing required step parameter: title\n" + JSON.stringify(data, null, 2) + "\n" + "see this doc for more detail: https://github.com/LikaloLLC/tourguide.js#json-based-approach");
        this.context.helpers.assert(data.hasOwnProperty("content"), "missing required step parameter: content\n" + JSON.stringify(data, null, 2) + "\n" + "see this doc for more detail: https://github.com/LikaloLLC/tourguide.js#json-based-approach");
      }
    }, {
      key: "_decorate",
      ...
      value: function _position($target) {
        var _this$$tooltip, _this$$highlight, _this$$highlight2;
        var _target = $target === null || $target === void 0 ? void 0 : $target.first();
        this.context.helpers.position(_target || document.body, (_this$$tooltip = this.$tooltip) === null || _this$$tooltip === void 0 ? void 0 : _this$$tooltip.first(), _target ? [positionabsolute(), this.context.helpers.autoPlacement({
        ...
        this.context.helpers.keepinview({
          padding: 24
        })] : [this.context.helpers.positionfixed(), this.context.helpers.highlight({
      ...
      value: function show() {
        ...
        if (!this.active) {
          ...
          this.context.helpers.smoothScroll($target.first(), {
            block: "center"
          }).then(function () {
            var _this5$$container;
            _this5._position($target);
            _this5.context.helpers.setStyle(_this5.$container, {
              opacity: 1
            });
      ...
      value: function hide() {
        this._cancel();
        if (this.active) {
          this.context.helpers.setStyle(this.$container, {
            opacity: 0
          });
  ...
  var MarkdownDecorator = new ContentDecorator("", function (text, matches, step, context) {
    return t(text);
  });
  ...
  var CardStep = /*#__PURE__*/function (_PopoverStep) {
    ...
    _createClass(CardStep, [{
      ...
      value: function _position() {
        var _this$$tooltip;
        this.context.helpers.position(document.body, (_this$$tooltip = this.$tooltip) === null || _this$$tooltip === void 0 ? void 0 : _this$$tooltip.first(), [this.context.helpers.positionfixed({
  ...
  _defineProperty(CardStep, "Style", Style);
  ...
  var Tour = /*#__PURE__*/function () {
    function Tour() {
      ...
      this._options = Object.assign({}, defaultOptions, options, {
        style: setAutoColors(defaultStyle, options.style || {})
      });
      u$2(this._options.root).append(this._containerElement = u$2(document.createElement("div")).addClass("__guided-tour-container"));
    ...
    _createClass(Tour, [{
      ...
      value: function _injectStyles() {
        var style = u$2("<style>".concat(Style$1, "</style>").concat(this.options.stepFactory.map(function (step) {
          return step.Style;
      ...
      value: function start() {
        ...
        if (this._ready) {
          setStyle(this._containerElement, {
